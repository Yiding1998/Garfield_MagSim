...
class AvalancheMicroscopic {
 public:
  ...
  void SetUserHandleCollision(void (*f)(double x, double y, double z, double t,
                                        ...
                                        std::size_t trackId,
                                        std::size_t parentTrackId,
                                        double fieldImpulseX,
                                        double fieldImpulseY,
 ...
 private:
  ...
  int TransportElectron(const Seed& seed, const bool signal,
                        ...
                        double& fieldImpulseX, double& fieldImpulseY,
                        double& fieldImpulseZ);
  ...
  void CreatePenningElectron(const double x, const double y, const double z,
                             ...
                             const int level, const std::size_t parentTrackId,
                             std::vector<Seed>& stack);
  void AccumulateElectricImpulse(const double x0, const double y0,
                                 const double z0, const double t0,
                                 const double x1, const double y1,
                                 const double z1, const double t1,
                                 const bool hole, double& ix, double& iy,
                                 double& iz) const;
  ...
  void CallUserHandles(const int cstype, const double x, const double y,
                       ...
                       const double kz1, const std::size_t trackId,
                       const std::size_t parentTrackId,
                       const double fieldImpulseX,
                       const double fieldImpulseY,
